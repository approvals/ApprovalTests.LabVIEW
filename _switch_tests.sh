...
g-cli switcheroo -- -t "Tests" -o "Source\\Extensions\\VITester.Extension\\VITester.Extension.lvlib" -r "<vilib>\\SAS\\Approval Tests\\Extensions\\lib_VITester.Extension.lvlib"
