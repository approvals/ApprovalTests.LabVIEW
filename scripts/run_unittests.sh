...
CARAYA_REPORT="$REPORTS_DIR/Caraya.PreBuild.UnitTestReport.xml"
LUNIT_REPORT="$REPORTS_DIR/LUnit.PreBuild.UnitTestReport.xml"
ERROR_PROPAGATION_REPORT="$REPORTS_DIR/ErrorPropagation.PreBuild.UnitTestReport.xml"
CORE_LIBRARY_REPORT="$REPORTS_DIR/CoreLibrary.PreBuild.UnitTestReport.xml"
